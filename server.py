...
# @app.route("/newindex")
# def return_main():
#     return render_template('newindex.hmtl')
...
def submit_rating():
    ...
    # Handle the rating logic, such as storing it in a database or processing it.
    
    # Redirect back to the ratings page with a success message
    return redirect(url_for('ratings', message=f"Thank you for rating {college_name} with a {rating}!"))

@app.route("/rating")
def ratings():
    # Get the message passed from the submit_rating route
...
def undergraduatealgo():
    ...
    return '''
        <html>
            <head>
                <title>College Recommendation Systems</title>
            ...
            <body>
                ...
                <div class="container">
                    <div class="jumbotron">
                        ...
                        <p class="lead"></p>
                          <p>The top recommended College for your preferences to be listed below! </p>
                            <table>
                            <tr><td><h4>S.No</h4></td><td><h4>College</h4></td><td><h4>Acceptance Rate</h4></td></tr>
...
def graduatealgo():
    ...
    return '''
        <html>
            ...
            <body>
                ...
                <div class="container">
                    <div class="jumbotron">
                        ...
                        <p class="lead"></p>
                            <p>
                                The Top recommended College for your preferences to be listed below!
                            </p>
                            <table>                     
                            <tr><td><h4>S.No</h4></td><td><h4>College</h4></td></tr>
            ...
            '''.format(result10 = list1[1], result20 = list1[2],result30 = list1[3], result40 = list1[4],result50 = list1[5])
